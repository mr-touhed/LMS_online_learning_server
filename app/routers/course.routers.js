...
const { insert_course, user_course_list, get_single_course, update_course, get_all_courses, remove_course } = require('../controllers/course.controllers');
...
courseRouter.delete("/course/:id",verify_token,remove_course);
